...
GObject.inherit(Je, a.GEventTarget)
...
Je.prototype.setSwatches = function (e, t, n) {
    ...
    if (o) {
      ...
      for (d = 0;
        d < l.length;
        ++d) r.getSwatches().removeChild(l[d]);
    }
  for (d = 0;
    d < t.length;
    ++d) r.getSwatches().appendChild(t[d]);
} else if (i) {
...
for (d = 0;
  d < u.length;
  ++d) p.push(a.GNode.serialize(u[d]));
...
Je.prototype.hasModifiedDocuments = function () {
    for (var e = !1, t = this.getDocuments(), n = 0;
      n < t.length;
      ++n)
    if (t[n].isModified()) {
      e = !0;
...
this._utm &&
this._utm.forEach((e, t) => dataLayer.push({
      [t]: e
    })),
this._updateDataLayerWithLicenseData(),
dataLayer.push({
    event: "USER_LOGGED_EVENT"
  })),
...
return new Promise((n, o) => {
    ...
    ee.advanced({
      ...
      closeCallback: (e) =>
      e && o({
          documentStatus: De.SaveCancelled
        }),
...
var r = pako.gzip(a.GNode.serialize(n), {
    level: 9
  }),
      ...
      t.read((t) => {
          try {
            for (
              ...
              i = a.GNode.deserialize(pako.ungzip(t, {
                    to: "string"
                  })),
            r = [],
            s = i.getFirstChild();
...
Je.prototype.requestLicenseUpdate = function () {
    let {
      showProOfferInTrial: e = s.LICENSE.UPGRADEABLE
    } =
  arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
  };
return (
