...
GObject.inherit(GToolbar, _core.GObject)
...
var c = $("<div></div>").addClass("toolbar-button").gPro({
    pro: r
  });
n && c.addClass(n),
e.action &&
...
GToolbar.prototype.createSimpleShapesMenu = function (e) {
  ...
  for (var i = e.annotations.annotList, a = 0;
    a < i.length;
    ++a) {
    var r = i[a];
    o
